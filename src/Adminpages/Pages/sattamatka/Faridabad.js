...
const FaridabadResult = () => {
    ...
    React.useEffect(() => {
        ...
        socket.on("oneminsattafaridabadamount", handleOneMinAmount);
        return () => {
            socket.off("onemin", handleOneMin);
            socket.off("oneminsattafaridabadamount", handleOneMinAmount);
        };
    }, []);
...
export default FaridabadResult;
