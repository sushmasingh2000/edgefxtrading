...
const GhaziabadResult = () => {
    ...
    React.useEffect(() => {
        ...
        socket.on("oneminsattagaziyabadamount", handleOneMinAmount);
        return () => {
            socket.off("onemin", handleOneMin);
            socket.off("oneminsattagaziyabadamount", handleOneMinAmount);
        };
    }, []);
...
export default GhaziabadResult;
