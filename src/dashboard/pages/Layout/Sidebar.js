...
import { FaAngleDown, FaAngleRight, FaCheck, FaCoins, FaExchangeAlt, FaMoneyBillWave, FaNetworkWired, FaSignOutAlt, FaTachometerAlt, FaTimes, FaUserAlt, FaUserCog, FaUserFriends, FaWallet } from "react-icons/fa";
...
const Sidebar = () => {
    ...
    const menuItems = [
        ...
        { title: "Associate Reg", icon: <FaCheck />, path: "/associate_registration" },
        { title: "Trade Account Details", icon: <FaCheck />, path: "/trading_registration" },
